...
📋 Features
Moduleคำอธิบาย🏠 Roomsจัดการห้องพัก สถานะ ราคา แผนผังชั้น👤 Tenantsข้อมูลผู้เช่า สัญญาเช่า เลือกห้อง💰 Paymentsค่าเช่า ค่าน้ำ ค่าไฟ ยืนยันการชำระ📊 Metersบันทึกมิเตอร์น้ำ-ไฟประจำเดือน📦 Parcelsจัดการพัสดุ แจ้งเตือนผู้เช่า🔧 Repairsแจ้งซ่อม ติดตามสถานะ🧾 Invoicesออกบิล ส่งออก PDF📅 Bookingsจองห้องพัก📈 DashboardAdmin / Staff / Tenant แยกตาม role
...
Password: เบอร์โทรของผู้เช่า (ถ้าไม่มีใช้ 1234)
